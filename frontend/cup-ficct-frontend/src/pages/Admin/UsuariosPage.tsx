...
// Solo Administrador. Tabla con búsqueda, filtro por rol y estado.
// Modal para crear/editar. Desactivación/reactivación lógica.
...
const rolColors: Record<RolInterno, string> = {
  ...
  docente: "bg-emerald-500/10 text-emerald-600 border-emerald-500/20 dark:text-emerald-400",
};
...
function UsuarioModal({
  ...
  open: boolean;
  usuario: (Usuario & { password?: string }) | null;
  onClose: () => void;
  onSaved: () => void;
}) {
  ...
  // Cargar datos del usuario en edición o vaciar para creación.
  useEffect(() => {
    if (usuario) {
      setForm({
        id: usuario.id,
...
export function UsuariosPage() {
  ...
  useEffect(() => { cargar(); }, [search, filtroRol, filtroActivo]);
  ...
  return (
    <div className="space-y-6 p-6">
      <PageHeader
        ...
        description="Gestión de cuentas de acceso para administradores, coordinadores, autoridades y docentes."
      >
